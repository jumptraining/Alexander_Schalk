...
public class MatrixWithExceptions {
    ...
    public static void main(String[] args) throws WrongKeyException, InputMismatchException, FileNotFoundException {
        ...
        try {
            ...
            if (choice != 1 && choice != 2 && choice != 3) {
                throw new WrongKeyException("You didn't press 1, 2 or 3.");
            }
        } catch (InputMismatchException e) {
            System.out.println("That is an invalid input.\nPress 1, 2 or 3 instead.");
        }
